...
using static TE.BE.City.Domain.WeightErrorHandlingType;
...
namespace TE.BE.City.Domain
{
    ...
    /// </summary>
    /// 
    public class NewsDomain<T> : IEnumerable<T>, INewsDomain<T>
    {
        /// <summary>
        /// Create a new WeightedList with an optional System.Random.
        /// </summary>
        /// <param name="rand"></param>
        public NewsDomain(Random rand = null)
        {
        ...
        /// </summary>
        public NewsDomain(ICollection<WeightedListItem<T>> listItems, Random rand = null)
        {
            _rand = rand ?? new Random();
